...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border-[0.5px] border-opacity-20 bg-card p-6 shadow-sm transition-all hover:shadow-md text-card-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-display font-semibold leading-tight tracking-tight text-content-primary",
      className
    )}
    {...props}
  />
